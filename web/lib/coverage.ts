...
// this keeps every existing `@/lib/coverage` import working, unchanged.
//
// New code should import from "@ih/core/logic/coverage" directly. These shims are deleted when the last
