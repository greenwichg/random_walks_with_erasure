...
export const metadata: Metadata = {
  ...
  description:
    "What InfoDiet and its browser extension collect (article URLs and standard page metadata on supported news sites, only after you connect an account), what they never collect, and your controls.",
};
      ...
      <main className="mx-auto w-full max-w-2xl px-4 py-10 lg:py-14">
        ...
        <div className="mt-8 space-y-8 text-sm leading-relaxed">
          ...
          <Section title="The short version">
            <ul className="list-disc space-y-2 pl-5">
              <li>
                ...
                articles you open <strong>on a fixed list of supported news sites</strong> — never article
                text, never your general browsing history.
              </li>
              <li>
                It sends <strong>nothing anywhere</strong> until you explicitly connect it to your own
                InfoDiet account with an API token.
              </li>
              <li>
          ...
          <Section title="What the browser extension collects">
            <p>
              When — and only when — you open a page that is an <em>article</em> on one of the supported news
              sites listed in the extension&rsquo;s manifest, the extension records:
            </p>
            ...
            <p className="mt-2">
              Article detection uses standard signals only (OpenGraph tags, JSON-LD types, and the page&rsquo;s
          ...
          <Section title="What the extension never collects">
            <ul className="list-disc space-y-1 pl-5">
              ...
              <li>Your browsing history, or any activity on sites outside the supported list.</li>
              <li>Passwords, form input, cookies, or other page data.</li>
              <li>
                Analytics or telemetry of any kind: the extension contains no trackers and makes no requests
                to anyone other than the InfoDiet app address you configure.
              </li>
            </ul>
          </Section>
          ...
          <Section title="When collection starts">
            <p>
              The extension is <strong>inert until you connect it</strong>. Out of the box it stores nothing
              and sends nothing. Collection begins only after you complete all three setup steps in the
            ...
            <ol className="mt-2 list-decimal space-y-1 pl-5">
              ...
              <li>approve the browser permission for exactly that one address.</li>
            </ol>
            <p className="mt-2">
          ...
          <Section title="Where your data is stored">
            <p>
              ...
              configured, plus a short-lived duplicate-suppression cache of recently recorded article URLs.
              That cache is session-scoped and bounded: entries expire after 6 hours, the cache is capped in
              size, and it is cleared when your browser session ends. Uninstalling the extension deletes all
              of its local data.
            </p>
            <p className="mt-2">
          ...
          <Section title="Your controls">
            <ul className="list-disc space-y-1 pl-5">
              <li>
                <strong>Disconnect:</strong> revoke the token in InfoDiet → Settings, or clear it in the
                extension&rsquo;s Options — recording stops immediately.
              </li>
              <li>
