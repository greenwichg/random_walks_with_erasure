...
import type { TrendChart as Impl } from "./trend-chart-impl";

/**
 * Code-splitting boundary for TrendChart.
 *
 ...
 */
const Lazy = dynamic(() => import("./trend-chart-impl").then((m) => m.TrendChart), {
  ssr: false,
  loading: () => <div aria-hidden className="w-full animate-pulse rounded-lg bg-muted/40" />,
});

export function TrendChart(props: React.ComponentProps<typeof Impl>) {
  return (
