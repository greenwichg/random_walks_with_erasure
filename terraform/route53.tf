...
# real application records (apex + www) are imported.
...
import {
  to = aws_route53_zone.hidden_view
  id = "Z03237571N84XNOE3T8QU"
}
...
import {
  ...
  id = "Z03237571N84XNOE3T8QU_hidden-view.com_A"
}
...
import {
  ...
  id = "Z03237571N84XNOE3T8QU_www.hidden-view.com_A"
}
