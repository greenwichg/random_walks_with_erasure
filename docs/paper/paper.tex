...
\begin{enumerate}
  ...
  \textbf{human AllSides gold} (Qbias, $n{=}3{,}000$) the \emph{headline-only} classifier
  collapses to Cohen's $\kappa{=}0.007$, predicting \emph{centre} for $96\%$ of articles,
  whereas an \textbf{outlet lookup} recovers the same gold at
  $\kappa{=}0.84$ ($\kappa_{\mathrm{side}}{=}1.00$)---the lean lives in the \emph{publisher},
  not the headline, motivating an outlet-first axis); (ii)~a
