...
\begin{enumerate}
  ...
  from the \emph{text at any length}---$\kappa{=}0.007$ from the headline and $\kappa{=}0.001$
  from the full article body, collapsing to \emph{centre} both ways---whereas an
